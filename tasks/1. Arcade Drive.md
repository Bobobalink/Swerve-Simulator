...
This task will end up being a very simple refit of the tank drive example. The most difficult programming is figuring out
which side of the robot each wheel is on, and the tank drive code already does that.
